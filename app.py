...
app.layout = dbc.Container(fluid=True, children=[
    html.H1("Dashboard de Resultados", style={"textAlign": "center", "padding": "10px"}),
    ...
    dbc.Row([
        dbc.Col(dcc.Graph(id='top-filiais'), md=12)
    ], className='mb-4'),
...
def update_dashboard(json_data):
    ...
    fig_filiais = px.bar(df_utilizados['Nome da rede'].value_counts().nlargest(10).reset_index(),
                         x='index', y='Nome da rede', title='Top 10 Filiais com Mais Vouchers Utilizados')

    return kpis, fig_gerados, fig_utilizados, fig_ticket, fig_filiais
